...
export const IntroMiniCogPage: React.FC<IntroMiniCogPageProps> = ({ onStart }) => {
  const { status, isSpeaking } = useVoiceGuide(
    'ต่อไปจะเป็นการทดสอบความจำและการรู้คิดนะครับ แบบทดสอบนี้มีทั้งหมดสามขั้นตอน ขั้นแรก จะให้ฟังและจำคำศัพท์สามคำ ขั้นที่สอง จะให้วาดรูปหน้าปัดนาฬิกา และขั้นสุดท้าย จะกลับมาบอกคำศัพท์ที่จำไว้ ไม่ต้องกังวลนะครับ ทำเท่าที่ทำได้ ถ้าพร้อมแล้ว กดปุ่มด้านล่างเพื่อเริ่มได้เลยครับ'
  )
